                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class=" font-bold card-title text-success">Edit a Document</h3>
                        </div>
                                    ...
                                    <form action="{{route('document.update',$document)}}" method="POST">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="form-group col-sm-3">
                                                ...
                                                <input type="number" name="revision_status" value="{{$document->revision_status}}" class="btn-blue">
                                            </div>
                                            <div class="form-group col-sm-3">
                                                ...
                                                <select class="block w-full btn-blue mt-2" name="person_incharge" required>
                                                    ...
                                                    <option value="{{$user->id}}" {{ $document->person_incharge ==  $user->id ? 'selected' : '' }}>{{$user->job_title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-sm-3">
                                        ...
                                        <div class="row mt-2">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <select class="block w-full btn-blue mt-2" name="document_creator" required>
                                                    ...
                                                    @foreach($users as $user)
                                                    <option value="{{$user->id}}" {{ $document->document_creator ==  $user->id ? 'selected' : '' }}>{{$user->job_title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <p class="font-sans text-green-700 mb-2">Location of the document </p>
                                                <input type='text' name="location" class="btn-blue" value="{{ $document->location }}" />
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="form-group col-sm-12">
                                                <p class="font-sans text-green-700 mb-2">Comment if any </p>
                                                <textarea name="uploader_comment" rows="2" class="btn-blue">{{ $document->uploader_comment }}</textarea>
                                            </div>
                                        </div>
