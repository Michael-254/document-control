                        ...
                        <div class="card-body">
                            <div class="content animate__animated animate__zoomIn px-4 py-1">
                                ...
                                <div class="bg-indigo-50 shadow-2xl rounded-3xl">
                                    ...
                                    <form action="{{route('qc.update',$document)}}" method="POST">
                                        @csrf
                                        @method('patch')
                                        <div class="row px-3">
                                            <div class="form-group col-sm-6">
                                                <p class="font-sans font-bold text-green-500 mb-2">QC Decision</p>
                                                <div class="mt-2">
                                                    <label class="inline-flex items-center">
                                                        <input type="radio" class="form-radio text-green-500 focus:ring-gray-50" name="status" value="QC accepted">
                                                        <span class="ml-2 text-green-500">Accept</span>
                                                    </label>
                                                    <label class="inline-flex items-center ml-2">
                                                        <input type="radio" class="form-radio text-red-600 focus:ring-gray-50" name="status" value="QC rejected">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <textarea name="QC_comment" rows="2" class="btn-blue">{{ old('QC_comment') }}{{$document->QC_comment ?? ''}}</textarea>
                                            </div>
                                        </div>
